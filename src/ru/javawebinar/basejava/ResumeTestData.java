...
//                миграция" +
//                " базы (кастомизация Flyway), конфигурирование системы (pgBoucer, Nginx), AAA via SSO. Архитектура
//                БД" +
...
//        organization.addPeriod(new Period("06/2008", "12/2010", "Ведущий специалист", "Дизайн и имплементация Java
//        EE " +
...
//        organization.addPeriod(new Period("01/2005", "04/2005", "Курс 'Объектно-ориентированный анализ ИС.
//        Концептуальное " +
